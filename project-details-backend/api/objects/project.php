...
function read(){
    ...
    // select all query
    $query = "SELECT projectId,cityid,localityid,project_name,builderid,builder_name,property_type,construction_status 
            FROM
                " . $this->table_name ." limit 100";
...
function update(){
    ...
    $query = "UPDATE
            ...
            WHERE
            projectId = :projectId and property_type = :property_type" ;
